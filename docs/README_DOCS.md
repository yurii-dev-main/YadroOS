...
- Database: `docs/technical/database-schema.md`.
- Development process: `docs/technical/development-guide.md`.
- Environment auto-start: `docs/technical/auto-start-protocol.md`.
- Launch and production support: `docs/admin/launch-checklist.md` and `docs/admin/maintenance-plan.md`.

When adding new modules or processes, update the corresponding section and add a link here for ease of search.
