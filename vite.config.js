...
export default defineConfig(function (_a) {
    ...
    var demoFlag = (_b = env.DEMO_SINGLEFILE) !== null && _b !== void 0 ? _b : process.env.DEMO_SINGLEFILE;
    var isSingleFileDemo = demoFlag === 'true' || demoFlag === '1';
    return __assign(__assign({ base: isSingleFileDemo ? './' : '/', define: {
