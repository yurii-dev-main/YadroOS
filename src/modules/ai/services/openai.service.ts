...
export const generateAIResponse = async ({
  ...
  if (IS_DEMO_MODE) {
    return {
      content:
        "I'm the AI Assistant in demo mode! I can help you analyze your CRM, HR, or Accounting data.",
      actions: []
    };
  }
  ...
  if (IS_DEMO_MODE) {
    return {
        ...
        leadScores: [
          {
            ...
            score: 85,
            factors: [
              { label: 'High Engagement', value: 20 },
              { label: 'Budget Match', value: 15 }
            ],
        ...
        recommendations: [
          {
            ...
            description: 'John opened your last email.',
            type: 'action',
            confidence: 0.9
          }
        ],
        ...
        performance: [
          {
            ...
            normalizedScore: 92,
            trend: 'improving',
            highlights: ['Top performer this quarter', 'Excellent client feedback']
          }
        ],
        bonusBreakdown: [],
        recommendations: [
          {
            id: 'r2',
            title: 'Schedule 1:1 with Jane',
            description: 'Jane has been performing well.',
            type: 'action',
            confidence: 0.85
          }
        ],
        ...
        inbox: [
          {
            ...
            category: 'Support',
            priority: 'urgent',
            summary: 'Server down reported by client',
            suggestedActions: ['Reply acknowledging issue']
          },
          {
            id: 'c2',
            category: 'Sales',
            priority: 'normal',
            summary: 'New lead interested in enterprise plan',
            suggestedActions: ['Schedule demo']
          }
        ],
        autoReplies: []
      },
      accounting: {
        ...
        anomalies: [
          {
            ...
            description: 'Marketing spend is 40% higher than last month.',
            type: 'alert',
            confidence: 0.95
          }
        ],
        forecast: {
          horizonMonths: 12,
          baseline: Array.from({ length: 12 }).map((_, i) => ({
            period: `M${i + 1}`,
            value: 100000 + i * 5000,
            lowerBound: 90000 + i * 4000,
            upperBound: 110000 + i * 6000
          })),
          bestCase: [],
          worstCase: []
        }
      ...
      executive: {
        ...
        insights: [
          {
            id: 'i1',
            message: 'Strong quarter ahead based on pipeline velocity.',
            category: 'crm',
            severity: 'info'
          }
        ],
